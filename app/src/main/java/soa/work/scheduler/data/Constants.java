...
public class Constants {
    ...
    public static final String MAKEUP = "Bridal & Groom Makeup";
    public static final String MEHENDI = "Bridal Mehendi";
    public static final String CATERING = "Catering";
    public static final String PHOTOGRAPHY = "Photography/Videography";
    public static final String DRIVING = "Driving School";
    public static final String HOME_TUTOR = "Home Tutor";
    public static final String HOME_CLEAN = "Home Cleaning";
